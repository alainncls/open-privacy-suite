...
import type { CreateDisclosureRequestInput, DisclosureScope, DisclosureLevel } from '@/types/disclosure';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm text-[#374151]">
              Target User <span className="text-[#EF4444]">*</span>
            </label>
            ...
            {selectedUser ? (
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showUserDropdown && !usersLoading && (
                  <div className="absolute z-50 w-full mt-1 max-h-60 overflow-auto rounded-lg border border-[#E2E8F0] bg-white shadow-elevated">
                    {usersError ? (
                      ...
                      filteredUsers.map((user) => (
                        <button
                          ...
                          className="w-full p-3 text-left hover:bg-[#F5F3FF] transition-colors border-b border-[#F1F5F9] last:border-b-0"
                        >
            ...
            {errors.user_external_id && (
              <p className="text-[#EF4444] text-xs">{errors.user_external_id}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-sm text-[#374151]">
                Requester Name <span className="text-[#EF4444]">*</span>
              </label>
              <Input
              ...
              {errors.requester_name && (
                <p className="text-[#EF4444] text-xs">{errors.requester_name}</p>
              )}
            </div>
            <div className="space-y-2">
              <label className="text-sm text-[#374151]">Organization</label>
              <Input
          ...
          <div className="space-y-2">
            ...
            {selectedRequester ? (
              <div className="flex items-center gap-2 p-3 rounded-lg border border-[#22C55E] bg-[#DCFCE7]">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-[#6B7280] truncate">{user.id}</p>
                            </div>
                          </div>
                        </button>
                      ))
          ...
          <div className="space-y-2">
            <label className="text-sm text-[#374151]">
              Purpose <span className="text-[#EF4444]">*</span>
            </label>
            <Textarea
            ...
            />
            {errors.purpose && (
              <p className="text-[#EF4444] text-xs">{errors.purpose}</p>
            )}
          </div>

          {/* Legal Basis */}
          <div className="space-y-2">
            <label className="text-sm text-[#374151]">Legal Basis</label>
            <Input
          ...
          {/* Reference */}
          <div className="space-y-2">
            <label className="text-sm text-[#374151]">Request Reference</label>
            <Input
          ...
          <div className="space-y-3">
            <label className="text-sm text-[#374151]">
              Requested Data Scope <span className="text-[#EF4444]">*</span>
            </label>
            <div className="space-y-2">
                  ...
                  <button
                    ...
                    className={`w-full p-3 rounded-lg border text-left transition-all ${
                      isSelected
                        ...
                        : 'border-[#E2E8F0] bg-white hover:bg-[#F5F3FF]'
                    }`}
                  >
            ...
            {errors.scope && (
              <p className="text-[#EF4444] text-xs">{errors.scope}</p>
            )}
          </div>
          ...
          <div className="space-y-3">
            <label className="text-sm text-[#374151]">
              Disclosure Level <span className="text-[#EF4444]">*</span>
            </label>
            <p className="text-xs text-[#6B7280]">
            ...
            {errors.disclosure_level && (
              <p className="text-[#EF4444] text-xs">{errors.disclosure_level}</p>
            )}
          </div>

          {/* Validity Period */}
          <div className="space-y-3">
            <label className="text-sm text-[#374151] flex items-center gap-2">
              <span>Validity Period</span>
              <Info className="w-4 h-4 text-[#94A3B8]" />
            </label>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-xs text-[#6B7280]">Start Date (optional)</label>
                <Input
                  type="datetime-local"
              ...
              <div className="space-y-2">
                <label className="text-xs text-[#6B7280]">End Date (optional)</label>
                <Input
                  type="datetime-local"
                ...
                />
                {errors.valid_until && (
                  <p className="text-[#EF4444] text-xs">{errors.valid_until}</p>
                )}
              </div>
            </div>
          </div>
