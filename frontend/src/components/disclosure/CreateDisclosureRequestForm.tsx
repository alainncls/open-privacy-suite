      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {selectedUser ? (
              <div className="flex items-center gap-2 p-3 rounded-lg border border-primary-500/50 bg-primary-500/10">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showUserDropdown && !usersLoading && (
                  <div className="absolute z-50 w-full mt-1 max-h-60 overflow-auto rounded-lg border border-white/10 bg-gray-900/95 backdrop-blur-sm shadow-lg">
                    {usersError ? (
                      <div className="p-3 text-sm text-red-400">{usersError}</div>
            ...
            {errors.user_external_id && (
              <p className="text-red-400 text-xs">{errors.user_external_id}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              {errors.requester_name && (
                <p className="text-red-400 text-xs">{errors.requester_name}</p>
              )}
            </div>
            <div className="space-y-2">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-white/50 truncate">{user.id}</p>
                            </div>
                          </div>
                        </button>
                      ))
          ...
          <div className="space-y-2">
            ...
            />
            {errors.purpose && (
              <p className="text-red-400 text-xs">{errors.purpose}</p>
            )}
          </div>

          {/* Legal Basis */}
          <div className="space-y-2">
            <label className="text-sm text-white/70">Legal Basis</label>
            <Input
          ...
          {/* Reference */}
          <div className="space-y-2">
            <label className="text-sm text-white/70">Request Reference</label>
            <Input
          ...
          <div className="space-y-3">
            <label className="text-sm text-white/70">
              Requested Data Scope <span className="text-red-400">*</span>
            </label>
            <div className="space-y-2">
            ...
            {errors.scope && (
              <p className="text-red-400 text-xs">{errors.scope}</p>
            )}
          </div>
          ...
          <div className="space-y-3">
            <label className="text-sm text-white/70">
              Disclosure Level <span className="text-red-400">*</span>
            </label>
            <p className="text-xs text-white/50">
            ...
            {errors.disclosure_level && (
              <p className="text-red-400 text-xs">{errors.disclosure_level}</p>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-xs text-white/50">Start Date (optional)</label>
                <Input
                  type="datetime-local"
              ...
              <div className="space-y-2">
                <label className="text-xs text-white/50">End Date (optional)</label>
                <Input
                  type="datetime-local"
                ...
                />
                {errors.valid_until && (
                  <p className="text-red-400 text-xs">{errors.valid_until}</p>
                )}
              </div>
            </div>
          </div>
