      ...
      <CardContent>
        {loading && logs.length === 0 ? (
          <div className="flex items-center justify-center py-12" role="status" aria-live="polite">
            <Loader2 className="w-6 h-6 text-neutral-400 animate-spin" aria-hidden="true" />
          ...
          <div className="text-center py-12">
            ...
            <p className="text-neutral-400">No access logs yet</p>
            <p className="text-neutral-400 text-sm mt-1">Logs will appear here when requests are made</p>
          </div>
        ) : (
          <Table>
            <TableHeader>
