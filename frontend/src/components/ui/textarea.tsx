  ...
  "flex min-h-[80px] w-full text-sm transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-[#F1F5F9]",
  {
    variants: {
      variant: {
        ...
        code: "rounded-lg border border-[#E2E8F0] bg-[#1A1A1A] px-4 py-3 font-mono text-sm text-[#E2E8F0] placeholder:text-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#8950FA]/20 focus:border-[#8950FA] resize-none",
      },
    },
    defaultVariants: {
      variant: "default",
