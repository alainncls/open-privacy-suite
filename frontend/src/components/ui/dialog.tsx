...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 text-[#6B7280] transition-all hover:text-[#0F0F0F] hover:bg-[#F1F5F9] focus:outline-none focus:ring-2 focus:ring-[#8950FA]/40 disabled:pointer-events-none">
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight text-[#0F0F0F]",
      className
    )}
    {...props}
  />
