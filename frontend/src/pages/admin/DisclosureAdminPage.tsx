    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#8950FA] to-[#A478FC] flex items-center justify-center shadow-lg shadow-primary">
      ...
      {error && (
        <Card variant="default" className="border-[#FEE2E2]">
      ...
      {successMessage && (
        <Card variant="default" className="border-[#BBF7D0]">
          <CardContent className="py-4">
            <div className="flex items-center gap-3">
        ...
        <Card variant="default" className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#94A3B8]">Revoked</p>
            </div>
          </div>
        </Card>
        <Card variant="default" className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#94A3B8]">Expired</p>
            </div>
          </div>
        </Card>
      </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            {request.requester_org && (
                              <p className="text-[#94A3B8] text-sm">{request.requester_org}</p>
                            )}
                            <p className="text-[#6B7280] text-xs mt-1">{request.purpose}</p>
                          </div>
