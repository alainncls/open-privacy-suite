...
### 2. Contract deployment: deployed address visible when deployer is private
...
### 3. Gas parameters are not hidden
...
### 4. Value inference from public address balance history
