...
Some deploy-transaction metadata (e.g. the created contract address) is not redacted in the current release.

**Mitigation:** Register deployed contracts to the deployer's org so their activity is access-controlled.
