...
<Callout variant="warning" title="Threat model — be honest about what this defends against">
...
<Callout variant="warning" title="New-table checklist for future migration authors">
...
<Callout variant="warning" title="Migrations need the admin role">
