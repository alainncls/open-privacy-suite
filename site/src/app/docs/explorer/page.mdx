...
### What Org Admins Can and Cannot See

Org admins (`is_org_admin` group or `admin` claim in contract_grants) have **full visibility on org contracts** — all contract calls, contract-to-contract interactions, and contract state are visible. However, **individual user wallets (EOAs) remain private** even to org admins:
