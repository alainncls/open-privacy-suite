...
└── tests/
    ...
    └── demo/           # cross-product acceptance: 00-setup, 00-cleanup, 10-rbac-explorer,
                        # 20-disclosure, 30-travel-rule, 40-view-as, 50-explorer-conformance,
                        # 60-transaction-matrix
