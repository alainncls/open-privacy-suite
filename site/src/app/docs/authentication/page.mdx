...
The Privacy Proxy authenticates users through **Privado ID zero-knowledge proofs** with optional
...
Users can link Ethereum addresses to their DID after authentication using EIP-191 signatures.
