...
| No access to contract (Hidden emitter) | Any | Any | **Participant** | **No** (participation does not override the grant bound) |
| No access to contract (Hidden emitter) | Any | Any | in tx `visibleTo`, no unlock | **No** (RD-1208; ordinary visibleTo does not override the grant bound) |
